	...
	<nav class="navbar navbar-expand-sm navbar-dark bg-dark mb-3">
		...
		<div
			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/transactionDetailList">History</a>
				</li>
				<li class="nav-item"><a class="nav-link"
					href="${pageContext.request.contextPath}/userProfile">Profile</a></li>
			</ul>
		</div>
		<div
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item"><a class="nav-link text-primary"
					href="${pageContext.request.contextPath}/userLogout">Logout</a></li>
			</ul>
		</div>
